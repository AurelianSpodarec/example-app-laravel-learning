<header>
    ...
    <nav class="bg-white border-b-2 border-gray-50">
    ...
    <div class="flex items-center justify-between h-20">
        ...
        <div class="ml-4 flex items-center md:ml-6">
            <a href="#" class="text-gray-900 hover:bg-gray-700 hover:text-gray-900  px-3 py-2 rounded-md text-sm font-medium">Sign In</a>
            <a href="#" class="text-gray-900 hover:bg-gray-700 hover:text-gray-900  px-3 py-2 rounded-md text-sm font-medium">Sign Up</a>
        </div>
        </div>
